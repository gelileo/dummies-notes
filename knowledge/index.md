...
| [concepts/dummies-notes/orchestration-workflow.md](concepts/dummies-notes/orchestration-workflow.md) | The dummies-notes Workflow (shipped): registry-aware BFS decomposition, illustrate + fresh-eyes review per atomic node, finalize + graph check; first run illustrated modular-arithmetic end-to-end | 2026-06-10 |
